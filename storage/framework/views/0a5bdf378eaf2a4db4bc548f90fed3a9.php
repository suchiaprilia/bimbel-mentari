            ...
            <div style="flex: 1; min-width: 300px;">
                ...
                <select name="jadwal_id" style="width: 100%; padding: 14px; border-radius: 14px; border: 1px solid #d8e0ea; background: #f8fafc; color: #072d54; font-weight: 600;">
                    ...
                    <?php $__currentLoopData = $jadwal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($item->id_jadwal); ?>" <?php echo e(request('jadwal_id') == $item->id_jadwal ? 'selected' : ''); ?>>
                            <?php echo e(\Carbon\Carbon::parse($item->tanggal)->translatedFormat('d M Y')); ?> | <?php echo e($item->jam_mulai); ?> - <?php echo e($item->jam_selesai); ?> | <?php echo e($item->mapel->nama_mapel ?? '-'); ?> (Kelas <?php echo e($item->kelas->nama_kelas ?? '-'); ?>)
                        </option>
    ...
    <div class="card" style="padding: 0; overflow: hidden; border-radius: 28px;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <div>
                    <h2 style="margin: 0; font-size: 20px; font-weight: 800; color: #072d54;">
                        <?php echo e($selectedJadwal->mapel->nama_mapel ?? '-'); ?> - Kelas <?php echo e($selectedJadwal->kelas->nama_kelas ?? '-'); ?>

                    </h2>
                    <p style="margin: 5px 0 0; color: #6f7b8a; font-size: 14px; font-weight: 600;">
                        <i class="fa-solid fa-calendar-day mr-1"></i> <?php echo e(\Carbon\Carbon::parse($selectedJadwal->tanggal)->translatedFormat('l, d F Y')); ?>

                    </p>
                </div>
                <div style="display: flex; gap: 10px; align-items: center; justify-content: flex-end;">
                    <a href="<?php echo e(route('guru.nilai.template', ['jadwal_id' => $selectedJadwal->id_jadwal])); ?>" class="btn" style="background: #10b981; color: white; padding: 8px 15px; border-radius: 12px; text-decoration: none; font-size: 13px; font-weight: bold;"><i class="fa-solid fa-download"></i> Template Excel</a>
        ...
        <div style="padding: 35px;">
            <form method="POST" action="/guru/nilai/store">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="jadwal_id" value="<?php echo e($selectedJadwal->id_jadwal); ?>">
                ...
                <div style="max-width: 400px; margin-bottom: 30px;">
                    ...
                    <input type="text" name="jenis_nilai" value="<?php echo e(old('jenis_nilai')); ?>" 
                ...
                <div class="table-responsive">
                    <table class="table-custom">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $siswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td style="text-align: center; font-weight: 700; color: #7b8490;"><?php echo e($index + 1); ?></td>
                                <td style="font-weight: 800; color: #072d54;"><?php echo e($item->nama_siswa); ?></td>
                                <td style="text-align: center;">
                                    <input type="number" name="nilai[<?php echo e($item->id); ?>]" value="<?php echo e(old('nilai.' . $item->id)); ?>"
                                           min="0" max="100" step="0.01" class="input-nilai" placeholder="0">
                                </td>
                                <td>
                                    <input type="text" name="keterangan[<?php echo e($item->id); ?>]" value="<?php echo e(old('keterangan.' . $item->id)); ?>"
...
<?php if($selectedJadwal && $riwayatNilai->count() > 0): ?>
    ...
    <div class="card" style="padding: 0; overflow: hidden; border-radius: 28px;">
        <div style="background: linear-gradient(135deg, #003b70 0%, #064b86 100%); padding: 22px 35px; display: flex; justify-content: space-between; align-items: center;">
            ...
            <span style="background: rgba(255,255,255,0.2); color: white; padding: 8px 16px; border-radius: 12px; font-size: 13px; font-weight: 700;">
                <?php echo e($riwayatNilai->count()); ?> Entri
            </span>
        </div>

        <div style="padding: 0 35px 35px;">
            <?php $grouped = $riwayatNilai->groupBy('jenis_nilai'); ?>

            <?php $__currentLoopData = $grouped; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenis => $entries): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div style="margin-top: 28px;">
                <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 15px;">
                    ...
                    <span style="color: #9aa5b4; font-size: 12px;">
                        <?php echo e($entries->first()->created_at->translatedFormat('d F Y, H:i')); ?>
                ...
                <div class="table-responsive">
                    <table class="table-custom" style="font-size: 14px;">
                        ...
                        <tbody>
                        <?php $__currentLoopData = $entries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td style="text-align: center; color: #9aa5b4; font-weight: 700;"><?php echo e($idx + 1); ?></td>
                                <td style="font-weight: 700; color: #072d54;"><?php echo e($r->siswa->nama_siswa ?? '-'); ?></td>
                                <td style="text-align: center;">
                                    <?php $n = (float) $r->nilai; ?>
                                    <span style="
                                        ...
                                        font-weight: 800;
                                        font-size: 14px;
                                        background: <?php echo e($n >= 80 ? '#ecfdf5' : ($n >= 60 ? '#fffbeb' : '#fee2e2')); ?>;
                                        color: <?php echo e($n >= 80 ? '#059669' : ($n >= 60 ? '#d97706' : '#dc2626')); ?>;
                                        border: 1px solid <?php echo e($n >= 80 ? '#a7f3d0' : ($n >= 60 ? '#fde68a' : '#fecaca')); ?>;
                                    "><?php echo e(number_format($n, 0)); ?></span>
                                </td>
                                <td style="color: #6f7b8a; font-size: 13px;"><?php echo e($r->keterangan ?? '-'); ?></td>
                                <td style="text-align: center; color: #9aa5b4; font-size: 12px;">
                                    <?php echo e($r->created_at->format('d M Y')); ?>

                                </td>
                                <td style="text-align: center;">
                                    <a href="/guru/nilai/delete/<?php echo e($r->id); ?>"
...
<?php elseif($selectedJadwal && $riwayatNilai->count() === 0): ?>
...
<div id="modalExcel" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 1000; justify-content: center; align-items: center;">
    <div style="background: white; padding: 30px; border-radius: 20px; width: 400px; max-width: 90%;">
        ...
        <form method="POST" action="<?php echo e(route('guru.nilai.import')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="jadwal_id" value="<?php echo e($selectedJadwal->id_jadwal ?? ''); ?>">
...
<?php echo $__env->make('guru_user.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bimbel-mentari\resources\views/guru_user/nilai.blade.php ENDPATH**/ ?>