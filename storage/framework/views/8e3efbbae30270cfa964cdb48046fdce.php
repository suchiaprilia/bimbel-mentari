...
<div class="layout">
    ...
    <aside class="sidebar">
        ...
        <div class="menu">
            ...
            <a href="/siswa-dashboard" class="<?php echo e(request()->is('siswa-dashboard') ? 'active' : ''); ?>"><i class="fa-solid fa-house"></i> Dashboard</a>
            <a href="/siswa/jadwal" class="<?php echo e(request()->is('siswa/jadwal') ? 'active' : ''); ?>"><i class="fa-solid fa-calendar-days"></i> Jadwal Belajar</a>
            <a href="/siswa/materi" class="<?php echo e(request()->is('siswa/materi') ? 'active' : ''); ?>"><i class="fa-solid fa-book-open"></i> Materi</a>
            <a href="/siswa/nilai" class="<?php echo e(request()->is('siswa/nilai') ? 'active' : ''); ?>"><i class="fa-solid fa-graduation-cap"></i> Nilai</a>
            <a href="/siswa/pembayaran" class="<?php echo e(request()->is('siswa/pembayaran') ? 'active' : ''); ?>"><i class="fa-solid fa-money-bill-wave"></i> Pembayaran</a>
            <a href="/siswa/profil" class="<?php echo e(request()->is('siswa/profil') ? 'active' : ''); ?>"><i class="fa-solid fa-user"></i> Profil Saya</a>

            <?php if(session('is_parent_mode') || session('parent_mode')): ?>
                <?php
                    $unreadBalasan = 0;
                    $user = Auth::user();
                ...
                ?>
                <a href="/siswa/parent/konsultasi" class="<?php echo e(request()->is('siswa/parent/konsultasi') ? 'active' : ''); ?>" style="display: flex; justify-content: space-between; align-items: center;">
                    <span><i class="fa-solid fa-comments"></i> Konsultasi Guru</span>
                    <?php if($unreadBalasan > 0): ?>
                        <span style="background: #ef4444; color: white; padding: 2px 8px; border-radius: 10px; font-size: 11px; font-weight: bold;"><?php echo e($unreadBalasan); ?></span>
                    <?php endif; ?>
                </a>
            <?php endif; ?>

            <div style="margin-top: 20px;">
                <?php if(session('parent_mode')): ?>
                    <a href="<?php echo e(route('siswa.toggle-parent')); ?>" class="btn-switch parent-active"><i class="fa-solid fa-user-check"></i> <span>Mode Orang Tua: ON</span></a>
                <?php else: ?>
                    <a href="<?php echo e(route('siswa.toggle-parent')); ?>" class="btn-switch"><i class="fa-solid fa-user-group"></i> <span>Akses Orang Tua</span></a>
                <?php endif; ?>
            </div>
...
</html><?php /**PATH C:\laragon\www\bimbel-mentari\resources\views/siswa_user/layout.blade.php ENDPATH**/ ?>