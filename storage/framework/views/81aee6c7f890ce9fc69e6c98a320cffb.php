...
<div class="container main-box">
  <div class="row w-100">
          ...
          <div class="col-md-7 form-side">
            ...
            <?php if($namaProgram): ?>
              <div class="selected-program-info">
                ...
                Anda sedang mendaftar untuk <strong><?php echo e($namaProgram); ?></strong>.
            ...
            <form action="<?php echo e(route('daftar.store')); ?>" method="POST">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="nama_siswa" class="form-control"
                  value="<?php echo e(old('nama_siswa')); ?>" placeholder="Masukkan nama lengkap siswa" required>
              </div>

              <div class="mb-3">
                <label>Nama Orang Tua</label>
                <input type="text" name="nama_ortu" class="form-control"
                  value="<?php echo e(old('nama_ortu')); ?>" placeholder="Masukkan nama orang tua/wali">
              </div>

              <div class="mb-3">
                <label>No WhatsApp <span class="text-danger">*</span></label>
                <input type="text" name="no_whatsapp" class="form-control"
                  value="<?php echo e(old('no_whatsapp')); ?>" placeholder="Contoh: 081234567890" required>
              ...
              <div class="row">
                <div class="col-md-6 mb-3">
                  ...
                  <select name="jenjang" class="form-select">
                    ...
                    <option value="SD" <?php echo e($selectedJenjang == 'SD' ? 'selected' : ''); ?>>SD</option>
                    <option value="SMP" <?php echo e($selectedJenjang == 'SMP' ? 'selected' : ''); ?>>SMP</option>
                    <option value="SMA" <?php echo e($selectedJenjang == 'SMA' ? 'selected' : ''); ?>>SMA</option>
                  </select>
                </div>
    ...
    <select name="id_kelas"
        class="form-select <?php $__errorArgs = ['id_kelas'];
...
unset($__errorArgs, $__bag); ?>">
        ...
        <?php $__currentLoopData = $kelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <option value="<?php echo e($k->id); ?>"
                <?php echo e(old('id_kelas') == $k->id ? 'selected' : ''); ?>>
                  ...
                  <div class="row" id="mapel-list">
                    ...
                    <div class="col-md-6 mb-2 mapel-item">
                      <div class="form-check custom-checkbox">
                        <input class="form-check-input" type="checkbox" name="mapel_id[]" value="<?php echo e($m->id_mapel); ?>" id="mapel<?php echo e($m->id_mapel); ?>">
...
</html><?php /**PATH C:\laragon\www\bimbel-mentari\resources\views/daftar.blade.php ENDPATH**/ ?>