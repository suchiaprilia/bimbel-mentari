...
<div class="profile-page">
    <section class="profile-hero">
        <div>
            <span class="hero-label"><i class="fa-solid fa-graduation-cap"></i> Profil Siswa</span>
        ...
        <div class="status-badge"><?php echo e($siswa->status); ?></div>
    </section>
    ...
    <div class="profile-grid">
        <aside class="profile-card profile-summary">
            ...
            <div>
                <h2><?php echo e($siswa->nama_siswa); ?></h2>
                <p>Siswa kelas <?php echo e($siswa->kelas->nama_kelas ?? 'Umum'); ?></p>
            </div>

            <div class="profile-metadata">
                <div class="meta-item">
                    <label>Nomor WhatsApp</label>
                    <span><?php echo e($siswa->no_whatsapp); ?></span>
                </div>

                <div class="meta-item">
                    <label>Alamat</label>
                    <span><?php echo e($siswa->alamat ?: 'Belum diisi'); ?></span>
                </div>

                <div class="meta-item">
                    <label>Akun Terdaftar</label>
                    <span><?php echo e($siswa->user->email ?? 'Email tidak tersedia'); ?></span>
                </div>
            </div>
        </aside>
        ...
        <div>
            <div class="profile-form-card">
                ...
                <p>Gunakan tombol edit untuk memperbarui data siswa. Setelah selesai, simpan perubahan agar informasi tersimpan dengan benar.</p>
                ...
                <form method="POST" action="/siswa/profil/update">
                    <?php echo csrf_field(); ?>

                    <div class="form-grid">
                        <div class="field-group">
                            <label for="nama_siswa">Nama Siswa</label>
                            <input type="text" id="nama_siswa" name="nama_siswa" value="<?php echo e($siswa->nama_siswa); ?>" readonly>
                        </div>

                        <div class="field-group">
                            <label for="no_whatsapp">No WhatsApp</label>
                            <input type="text" id="no_whatsapp" name="no_whatsapp" value="<?php echo e($siswa->no_whatsapp); ?>" readonly>
                        </div>
                    </div>

                    <div class="field-group">
                        <label for="alamat">Alamat</label>
                        <textarea id="alamat" name="alamat" readonly><?php echo e($siswa->alamat); ?></textarea>
                    </div>
        ...
        <div class="modal-card">
            ...
            <?php if(session('error_password')): ?>
                <div class="alert-box alert-error">
                    ...
                    <?php echo e(session('error_password')); ?>
...
<script>
    ...
    const inputs = document.querySelectorAll('input[id^="nama_siswa"], input[id^="no_whatsapp"], textarea[id^="alamat"]');
    ...
    /* AUTO OPEN MODAL */
    <?php if(session('success_password') || session('error_password')): ?>
        modal.classList.add('active');
    <?php endif; ?>
...
<?php echo $__env->make('siswa_user.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bimbel-mentari\resources\views/siswa_user/profil.blade.php ENDPATH**/ ?>