...
<?php $__env->startSection('content'); ?>
    ...
    <div class="materi-page">
        <div class="materi-header">
            ...
            <div class="badge"><?php echo e($materi->count()); ?> Materi</div>
        </div>
            ...
            <form action="/guru/materi/store" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" id="judul_materi" name="judul_materi" required placeholder="Masukkan judul materi" value="<?php echo e(old('judul_materi')); ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="id_kelas" name="id_kelas" required>
                            ...
                            <?php $__currentLoopData = $kelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($k->id); ?>" <?php echo e(old('id_kelas') == $k->id ? 'selected' : ''); ?>><?php echo e($k->nama_kelas); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="id_mapel" name="id_mapel" required>
                            ...
                            <?php $__currentLoopData = $mapel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($m->id_mapel); ?>" <?php echo e(old('id_mapel') == $m->id_mapel ? 'selected' : ''); ?>><?php echo e($m->nama_mapel); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="deskripsi" name="deskripsi" rows="4" placeholder="Tambahkan deskripsi singkat materi"><?php echo e(old('deskripsi')); ?></textarea>
                </div>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $materi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td><?php echo e($m->kelas->nama_kelas ?? '-'); ?></td>
                                ...
                                <td><?php echo e($m->tanggal_upload ?? '-'); ?></td>
                            </tr>
...
<?php echo $__env->make('guru_user.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bimbel-mentari\resources\views/guru_user/materi.blade.php ENDPATH**/ ?>