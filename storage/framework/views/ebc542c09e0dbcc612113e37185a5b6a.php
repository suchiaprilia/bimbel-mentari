...
<div class="container">
    <div class="page-header">
        ...
        <div class="action-buttons">
            <a href="<?php echo e(route('siswa.nilai.export')); ?>" class="btn-action btn-excel">
                <i class="fa-solid fa-file-excel"></i> Download Excel
            </a>
            <a href="<?php echo e(route('siswa.nilai.cetak')); ?>" target="_blank" class="btn-action btn-print">
                ...
                <table class="table-custom">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $nilai; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td style="text-align: center; color: #94a3b8; font-weight: 700;"><?php echo e($index + 1); ?></td>
                                <td>
                                    <div class="subject-name"><?php echo e($item->mapel->nama_mapel ?? '-'); ?></div>
                                </td>
                                <td>
                                    <span class="type-badge"><?php echo e($item->jenis_nilai); ?></span>
                                </td>
                                <td style="text-align: center;">
                                    ...
                                    ?>
                                    <div class="grade-badge <?php echo e($gradeClass); ?>">
                                        <?php echo e(number_format($n, 0)); ?>

                                    </div>
                                </td>
                                <td style="color: #64748b; font-size: 14px; font-style: italic;">
                                    <?php echo e($item->keterangan ?? 'Tidak ada catatan'); ?>
...
<?php echo $__env->make('siswa_user.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bimbel-mentari\resources\views/siswa_user/nilai.blade.php ENDPATH**/ ?>