...
<head>
  ...
  <title><?php echo e($program['nama']); ?> | Bimbel Mentari</title>
  ...
  <div class="container hero-content">
    <div class="row align-items-center">
      <div class="col-lg-8">
        ...
        <h4><?php echo e($program['kelas']); ?></h4>

        <p><?php echo e($program['deskripsi']); ?></p>

        <a href="/daftar?program=<?php echo e($slug); ?>" class="btn-daftar-detail">
      ...
      <div class="col-lg-4">
        <div class="hero-icon">
          <i class="<?php echo e($program['icon'] ?? 'fas fa-book-open'); ?>"></i>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-md-6 mb-4">
        <div class="info-card">
          ...
          <ul class="list-detail">
            <?php $__currentLoopData = ($program['materi'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $materi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <li>
                <i class="fas fa-check"></i>
                <span><?php echo e($materi); ?></span>
              </li>
      ...
      <div class="col-md-6 mb-4">
        <div class="info-card">
          ...
          <ul class="list-detail">
            <?php $__currentLoopData = ($program['keunggulan'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <li>
    ...
    <div class="row align-items-center">
      <div class="col-lg-5 mb-4 mb-lg-0">
        <div class="highlight-card">
          <h3>Mengapa Memilih <?php echo e($program['nama']); ?>?</h3>
          <p>
...
<section class="cta-detail">
  <div class="container">
    <h2>Tertarik Mengikuti <?php echo e($program['nama']); ?>?</h2>
    <p>
...
</html><?php /**PATH C:\laragon\www\bimbel-mentari\resources\views/program-detail.blade.php ENDPATH**/ ?>