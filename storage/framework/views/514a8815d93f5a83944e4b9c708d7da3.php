                ...
                <div class="materi-card">
                    ...
                    <div class="materi-body">
                        <span style="font-size: 11px; font-weight: 800; color: #0066cc; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 8px; display: block;">
                            <?php echo e($m->mapel->nama_mapel ?? 'Umum'); ?>

                        </span>
                        <h3><?php echo e($m->judul_materi); ?></h3>
                        <div class="materi-meta">
                            <i class="fa-solid fa-user-tie"></i>
                            <span><?php echo e($m->guru->nama_guru ?? '-'); ?></span>
                        </div>
                        
                        <?php if($m->file_materi): ?>
                            <div style="display: flex; gap: 10px; margin-top: auto;">
                                <a href="<?php echo e(asset('storage/' . $m->file_materi)); ?>" target="_blank" class="btn-download-premium" style="flex: 1; background: #e3f2fd; color: #0066cc;">
                                    <i class="fa-solid fa-eye"></i> Preview
                                </a>
                                <a href="<?php echo e(asset('storage/' . $m->file_materi)); ?>" download class="btn-download-premium" style="flex: 1;">
...
<?php echo $__env->make('siswa_user.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bimbel-mentari\resources\views/siswa_user/materi.blade.php ENDPATH**/ ?>