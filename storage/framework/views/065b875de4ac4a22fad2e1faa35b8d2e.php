...
<nav class="navbar navbar-expand-lg">
  <div class="container">
    <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
      <img src="<?php echo e(asset('images/logobimbel.png')); ?>" alt="Bimbel Mentari Logo" style="height: 65px; width: auto; object-fit: contain;">
    </a>
    ...
    <div class="row text-left">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="footer-brand">
          <img src="<?php echo e(asset('images/logobimbel.png')); ?>" alt="Bimbel Mentari Logo" style="height: 50px; width: auto; border-radius: 8px; margin-right: 15px;">
...
</html><?php /**PATH C:\laragon\www\bimbel-mentari\resources\views/home.blade.php ENDPATH**/ ?>