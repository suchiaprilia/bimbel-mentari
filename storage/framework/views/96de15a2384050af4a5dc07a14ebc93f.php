...
<?php $__empty_1 = true; $__currentLoopData = $konsultasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    <div class="inbox-card">
        <div class="inbox-header">
            <div class="inbox-student">
                <div class="student-avatar">
                    <?php echo e(strtoupper(substr($k->siswa->nama_siswa ?? 'S', 0, 1))); ?>

                </div>
                <div>
                    <strong style="font-size: 16px; color: #072d54; display: block;">
                        <?php echo e($k->siswa->nama_siswa ?? 'Siswa'); ?>
                    ...
                    <span style="font-size: 13px; color: #64748b;">
                        Kelas: <?php echo e($k->siswa->kelas->nama_kelas ?? '-'); ?>
        ...
        <div class="inbox-body">
            ...
            <div style="margin-bottom: 10px;">
                ...
                <h3 style="margin: 4px 0 15px 0; color: #0f172a; font-weight: 800; font-size: 18px;"><?php echo e($k->topik); ?></h3>
            </div>

            <div class="question-box">
                <div style="font-size: 12px; color: #64748b; margin-bottom: 8px; font-weight: 600;">
                    <i class="fa-solid fa-user-tag"></i> Dikirim oleh Orang Tua • <?php echo e($k->created_at->translatedFormat('d F Y, H:i')); ?>

                </div>
                <p style="margin: 0; line-height: 1.6; font-weight: 500;"><?php echo e($k->pertanyaan); ?></p>
            </div>
            ...
            <div class="reply-area">
                <?php if($k->jawaban): ?>
                    <div class="teacher-answer">
                        <div style="font-size: 12px; color: #15803d; margin-bottom: 8px; font-weight: 700;">
                            <i class="fa-solid fa-check-double"></i> Jawaban Anda Terkirim • <?php echo e($k->updated_at->translatedFormat('d F Y, H:i')); ?>

                        </div>
                        <p style="margin: 0; line-height: 1.6; font-weight: 500;"><?php echo e($k->jawaban); ?></p>
                        ...
                        <div style="margin-top: 15px; border-top: 1px dashed rgba(21, 128, 61, 0.2); padding-top: 12px;">
                            <details>
                                ...
                                <form action="/guru/konsultasi/<?php echo e($k->id); ?>/balas" method="POST" style="margin-top: 10px;">
                                    <?php echo csrf_field(); ?>
                                    <textarea name="jawaban" class="form-control" rows="3" required><?php echo e($k->jawaban); ?></textarea>
                ...
                <?php else: ?>
                    <div style="background: #fffcf5; border: 1px solid #fef3c7; padding: 20px; border-radius: 16px;">
                        ...
                        <form action="/guru/konsultasi/<?php echo e($k->id); ?>/balas" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('guru_user.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bimbel-mentari\resources\views/guru_user/konsultasi.blade.php ENDPATH**/ ?>