...
<div class="container">
    ...
    <?php if($siswa && $siswa->kelas && $siswa->kelas->jadwal->count()): ?>
        ...
        <?php $__currentLoopData = $groupedJadwal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date => $jadwals): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="date-section">
                <div class="date-badge">
                    <i class="fa-regular fa-calendar-check mr-2"></i> <?php echo e(\Carbon\Carbon::parse($date)->translatedFormat('l, d F Y')); ?>
                ...
                <div class="schedule-list">
                    <?php $__currentLoopData = $jadwals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="schedule-card">
                            <div class="time-slot">
                                <span>Waktu</span>
                                <strong><?php echo e($j->jam_mulai); ?></strong>
                                <small style="font-size: 10px; color: #adb5bd; font-weight: 700;">Sampai <?php echo e($j->jam_selesai); ?></small>
                            </div>

                            <div class="subject-info">
                                <h3><?php echo e($j->mapel->nama_mapel ?? '-'); ?></h3>
                                <div class="guru-pill">
                                    <i class="fa-solid fa-user-tie"></i>
                                    <span>Guru: <?php echo e($j->guru->nama_guru ?? '-'); ?></span>
                                </div>
                            </div>
...
<?php echo $__env->make('siswa_user.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bimbel-mentari\resources\views/siswa_user/jadwal.blade.php ENDPATH**/ ?>