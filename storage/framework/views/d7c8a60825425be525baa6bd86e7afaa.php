    ...
    <div class="profile-page">
        ...
        <div class="profile-grid">
            <aside class="profile-card profile-summary">
                ...
                <div>
                    <h2><?php echo e($guru->nama_guru); ?></h2>
                    <p>Guru mata pelajaran <?php echo e($guru->mapel->nama_mapel ?? 'Umum'); ?></p>
                </div>

                <div class="profile-metadata">
                    <div class="meta-item">
                        <label>Nomor WhatsApp</label>
                        <span><?php echo e($guru->no_whatsapp); ?></span>
                    </div>

                    <div class="meta-item">
                        <label>Alamat</label>
                        <span><?php echo e($guru->alamat ?: 'Belum diisi'); ?></span>
                    </div>

                    <div class="meta-item">
                        <label>Akun Terdaftar</label>
                        <span><?php echo e($guru->user->email ?? 'Email tidak tersedia'); ?></span>
                    </div>
                </div>
            </aside>
                    ...
                    <form method="POST" action="/guru/profil">
                        ...
                        <div class="form-grid">
                            <div class="field-group">
                                ...
                                <input type="text" id="nama_guru" name="nama_guru" value="<?php echo e($guru->nama_guru); ?>" readonly>
                            </div>

                            <div class="field-group">
                                <label for="no_whatsapp">No WhatsApp</label>
                                <input type="text" id="no_whatsapp" name="no_whatsapp" value="<?php echo e($guru->no_whatsapp); ?>" readonly>
                            </div>
                        </div>

                        <div class="field-group">
                            <label for="alamat">Alamat</label>
                            <textarea id="alamat" name="alamat" readonly><?php echo e($guru->alamat); ?></textarea>
                        </div>
...
<?php echo $__env->make('guru_user.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bimbel-mentari\resources\views/guru_user/profil.blade.php ENDPATH**/ ?>