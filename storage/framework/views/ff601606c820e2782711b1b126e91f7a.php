...
<div class="layout">
    <aside class="sidebar">
        ...
        <div class="menu">
            ...
            <a href="/guru-dashboard" class="<?php echo e(request()->is('guru-dashboard') ? 'active' : ''); ?>"><i class="fa-solid fa-house"></i> Dashboard</a>
            <a href="/guru/jadwal" class="<?php echo e(request()->is('guru/jadwal') ? 'active' : ''); ?>"><i class="fa-solid fa-calendar-days"></i> Jadwal Mengajar</a>
            <a href="/guru/materi" class="<?php echo e(request()->is('guru/materi') ? 'active' : ''); ?>"><i class="fa-solid fa-book-open"></i> Materi</a>
            <a href="/guru/nilai" class="<?php echo e(request()->is('guru/nilai') ? 'active' : ''); ?>"><i class="fa-solid fa-file-lines"></i> Nilai Siswa</a>
            <a href="/guru/profil" class="<?php echo e(request()->is('guru/profil') ? 'active' : ''); ?>"><i class="fa-solid fa-user"></i> Profil</a>
            <a href="/guru/konsultasi" class="<?php echo e(request()->is('guru/konsultasi') ? 'active' : ''); ?>">
                <i class="fa-solid fa-comments"></i> Konsultasi Masuk
                <?php if($unreadKonsultasi > 0): ?>
                    <span class="badge-nav"><?php echo e($unreadKonsultasi); ?></span>
                <?php endif; ?>
            </a>
            <a href="/guru/arsip-absensi" class="<?php echo e(request()->is('guru/arsip-absensi') ? 'active' : ''); ?>"><i class="fa-solid fa-box-archive"></i> Arsip Absensi</a>
...
</html><?php /**PATH C:\laragon\www\bimbel-mentari\resources\views/guru_user/layout.blade.php ENDPATH**/ ?>