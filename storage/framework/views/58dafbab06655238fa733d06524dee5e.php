                        ...
                        <td>
                            <?php if($a->user): ?>
                                <span style="background: #e9eff4; padding: 4px 8px; border-radius: 6px; font-size: 12px; font-weight: 600; color: #072d54;">
                                    <?php echo e(ucfirst($a->user->level)); ?>
                        ...
                        <td>
                            ...
                            <div style="display: flex; gap: 8px;">
                                <?php if($isPreviewable): ?>
                                    <button type="button" class="btn-info" onclick="openPreview('<?php echo e(Storage::url($a->file_path)); ?>', '<?php echo e(strtolower($extension)); ?>')">
                                        <i class="fa-solid fa-eye"></i> Preview
                                    </button>
                                <?php else: ?>
                                    <a href="<?php echo e(Storage::url($a->file_path)); ?>" target="_blank" class="btn-info" style="background: #28a745;">
                                        <i class="fa-solid fa-download"></i> Download
                                    </a>
                                <?php endif; ?>
                                <form action="/arsip-absensi/<?php echo e($a->id); ?>" method="POST" style="display:inline;" onsubmit="return confirm('Yakin ingin menghapus arsip ini?');">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('guru_user.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bimbel-mentari\resources\views/guru_user/arsip_absensi.blade.php ENDPATH**/ ?>