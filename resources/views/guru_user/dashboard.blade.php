...
@section('content')
    <div class="topbar">
        <div>
            <h1>Selamat Datang, {{ explode(' ', $guru->nama_guru)[0] }}! 👋</h1>
    ...
    @if($guru)
        ...
        <div class="grid">
            <div class="card stat">
                <div>
                    <h3>Jadwal Aktif</h3>
                    <strong style="color: #0066cc;">{{ $totalJadwal }}</strong>
            ...
            <div class="card stat">
                <div>
                    <h3>Total Siswa</h3>
                    <strong style="color: #f59e0b;">{{ $totalSiswa }}</strong>
            ...
            <div class="card stat">
                <div>
                    ...
                    <strong style="color: #10b981;">{{ $totalMateri }}</strong>
            ...
            <div class="card stat">
                <div>
                    ...
                    <strong style="color: #ef4444;">{{ $totalNilai }}</strong>
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: start; gap: 12px;">
                            <div>
                                ...
                                <div style="color: #6f7b8a; font-size: 13px;">
                                    <i class="fa-solid fa-door-open"></i> Kelas {{ $j->kelas->nama_kelas ?? '-' }}
                                </div>
                            </div>
            ...
            <div>
                ...
                <div class="card" style="background: linear-gradient(135deg, #003b70 0%, #064b86 100%); color: white; margin-bottom: 20px;">
                    <div style="text-align: center;">
                        ...
                        <h3 style="margin: 0 0 4px; font-size: 20px; font-weight: 800;">{{ $guru->nama_guru }}</h3>
                        ...
                        <div style="border-top: 1px solid rgba(255,255,255,0.2); padding-top: 16px;">
                            <p style="margin: 8px 0; font-size: 13px;">
                                <i class="fa-solid fa-phone"></i> {{ $guru->no_whatsapp }}
                            </p>
                            <p style="margin: 8px 0; font-size: 13px;">
                                <i class="fa-solid fa-map-marker"></i> {{ $guru->alamat ?? '-' }}
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="card" style="margin-top: 20px;">
            ...
            @forelse($materi->take(3) as $m)
                <div style="padding: 14px 0; border-bottom: 1px solid #f0f5fa; display: flex; justify-content: space-between; align-items: center;">
                    <div>
                        <div style="font-weight: 700; color: #072d54; margin-bottom: 4px;">{{ $m->judul_materi }}</div>
                        <div style="color: #6f7b8a; font-size: 13px;">{{ $m->kelas->nama_kelas ?? '-' }} • {{ $m->mapel->nama_mapel ?? '-' }}</div>
                    </div>
