...
<head>
    ...
    <title>@yield('judul', 'Admin Dashboard') | Bimbel Mentari</title>
...
<div class="layout">
    ...
    <aside class="sidebar">
        ...
        <div class="menu">
            ...
            <a href="{{ route('pendaftaran.index') }}" class="{{ request()->is('pendaftaran*') ? 'active' : '' }}">
            ...
            <a href="/mapel" class="{{ request()->is('mapel*') ? 'active' : '' }}">
            ...
            <a href="/tagihan" class="{{ request()->is('tagihan*') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.konsultasi') }}" class="{{ request()->is('admin/konsultasi*') ? 'active' : '' }}">
                <i class="fa-solid fa-comments"></i>
                <span>Konsultasi</span>
            </a>

            <a href="{{ route('admin.nilai') }}" class="{{ request()->is('admin/nilai*') ? 'active' : '' }}">
                <i class="fa-solid fa-star"></i>
                <span>Rekap Nilai</span>
            </a>

            <a href="/admin/arsip-absensi" class="{{ request()->is('admin/arsip-absensi*') ? 'active' : '' }}">
            ...
            <a href="/materi" class="{{ request()->is('materi*') ? 'active' : '' }}">
                <i class="fa-solid fa-book-open"></i>
                <span>Materi</span>
            </a>

            <a href="/notifikasi" class="{{ request()->is('notifikasi*') ? 'active' : '' }}">
    ...
    <main class="main-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="font-weight-bold mb-0" style="color: #072d54;">@yield('judul')</h2>
