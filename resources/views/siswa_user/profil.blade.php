...
<div class="profile-page">
    <section class="profile-hero">
        ...
        <div class="status-badge">{{ $siswa->status }}</div>
    </section>
    ...
    <div class="profile-grid">
        <aside class="profile-card profile-summary">
            ...
            <div>
                ...
                <p>Siswa kelas {{ $siswa->kelas->nama_kelas ?? 'Umum' }}</p>
            </div>
            ...
            <div class="profile-metadata">
                ...
                <div class="meta-item">
                    ...
                    <span>{{ $siswa->user->email ?? 'Email tidak tersedia' }}</span>
                </div>
            </div>
        </aside>
                ...
                <form method="POST" action="/siswa/profil/update">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="field-group">
                            ...
                            <input type="text" id="no_whatsapp" name="no_whatsapp" value="{{ $siswa->no_whatsapp }}" readonly>
                        </div>
                    </div>

                    <div class="field-group">
                        <label for="alamat">Alamat</label>
                        <textarea id="alamat" name="alamat" readonly>{{ $siswa->alamat }}</textarea>
                    </div>
...
<script>
    ...
    /* AUTO OPEN MODAL */
    @if(session('success_password') || session('error_password'))
        modal.classList.add('active');
    @endif
